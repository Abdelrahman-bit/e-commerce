// Products Management Module - Global object to avoid ES6 module issues
  ...
  renderHTML() {
    ...
    container.innerHTML = `
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <button class="btn btn-primary btn-sm" onclick="window.Products.showAddProductModal()">
              ...
              <form id="productForm">
                ...
                <div class="mb-3">
                  ...
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="window.openCloudinaryWidget()">
          ...
          <div class="row">
            ...
            <div class="col-9">
              ...
              <div class="d-flex gap-2 mt-3">
                ...
                <button class="btn btn-sm btn-outline-danger flex-fill" onclick="window.Products.deleteProductConfirm(${product.id})">
...
window.openCloudinaryWidget = function() {
  ...
  try {
    ...
    window.Products.showAlert(
      'Failed to open upload widget. Please use the image URL field instead.', 
      'warning'
    );
  }
}

// Make Products available globally for onclick handlers
